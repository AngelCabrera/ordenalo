                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Recibo de tu orden en Ordénalo</h1>
                                                                <strong>¡Hola! {{ $order->user->email }}</strong>
                                                                Te enviamos los datos de tu orden.
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a href="{{ url('orders/'.$order->id) }}">Ver más información en la página.</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2016 Ordénalo, All rights reserved.</em>
																<strong>Our mailing address is:</strong>
																<br />
																soporte@ordenalo.com
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
